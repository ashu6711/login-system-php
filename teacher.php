...
<div>
	<?php		
		...
		if(isset($_POST['submit']))
			...
			if (isset($type) and $type=='teacher'){
			require("db_connect.php");
			
			$query="SELECT * FROM teacher_reg WHERE email='$email'";		
			...
			$query1="select photo from teacher_reg where email='$email'";
	...
	?>
			...
			<p style="margin-left: 40%">	<?php echo "Department: ".$row['department']; ?></p>
			<p style="margin-left: 40%">	<?php echo "Address: ".$row['address']; ?> </p>
			<p style="margin-left: 40%">	<?php echo "Salary: ".$row['salary']; ?> </p>
