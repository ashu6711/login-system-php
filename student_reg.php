...
<body style="background-color: #ededed;">		
	<div style="margin-left: 30%;margin-top: 6%">
		...
		?>
		<h1 style="margin-left: 3%;margin-bottom: 2%">Student Registeration Form</h1>
			
  			
		<form style="margin-left: 100px;" action="student_db_insert.php" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
			    ...
			    <input type="text" class="form-control"  name="course" placeholder="Course type" style="width: 30%" required>
			</div>
